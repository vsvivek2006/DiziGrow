  ...
  const services = [
    {
      ...
      description: 'Professional logos, brand identity, and visual designs that make you stand out.',
      link: '/services'
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: 'Digital Marketing',
      description: 'SEO, social media, Google Ads, and Meta Ads to grow your online presence.',
      link: '/services'
    },
    {
      icon: <Code className="h-8 w-8" />,
      title: 'Web Development',
      description: 'Custom websites, e-commerce stores, and web applications built for success.',
      link: '/services'
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Grow Your Business 
              <span className="block text-yellow-400">Digitally with DiziGrow</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200">
              ...
              <p className="text-gray-600 mb-6">Perfect for new businesses starting their digital journey</p>
              <Link
                to="/pricing"
            ...
            <div className="bg-white p-8 rounded-xl shadow-xl border-2 border-yellow-400 relative">
              ...
              <p className="text-gray-600 mb-6">Ideal for growing businesses ready to scale</p>
              <Link
                to="/pricing"
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200">
              ...
              <p className="text-gray-600 mb-6">Complete digital transformation for established businesses</p>
              <Link
                to="/pricing"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 px-6 rounded-lg font-semibold transition-colors block text-center"
              >
